      ...
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl border border-gray-100 p-8 max-h-[90vh] overflow-y-auto">
        ...
        <div className="mt-6">
          ...
          <button
            ...
            disabled={loading}
            className="mt-6 w-full bg-white hover:bg-gray-50 text-gray-900 font-semibold py-3.5 px-6 rounded-lg border-2 border-gray-300 hover:border-gray-400 transition-all duration-200 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
          >
