    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-scene-fill rounded-2xl shadow-key border border-keyLight/10 p-8 max-h-[90vh] overflow-y-auto">
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-scene-fill hover:bg-scene-fillLight text-text-primary font-semibold py-3.5 px-6 rounded-lg border-2 border-keyLight/20 hover:border-gray-400 transition-all duration-200 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow-depth-md"
        >
